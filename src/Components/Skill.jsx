  ...
  return (
    <div name="skills" className="w-full h-screen bg-[#1e1e1e] text-[#fefefe]">
      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div
          class="inline-flex rounded-md shadow-sm max-w-[80%] mx-auto"
          role="group">
          <button
            type="button"
            onClick={handelOnClick}
            value={1}
            class="inline-flex items-center px-8 sm:px-16 py-4 text-sm align-middle text-center font-medium text-[#f3f3f3] bg-[#2e2e2e] border border-gray-400 rounded-l-lg hover:bg-gray-900 hover:text-[#1D94D4] focus:ring-2 focus:ring-[#1D94D4] focus:text-[#1D94D4] ">
            <svg
              class="w-3 h-3 mr-2"
              aria-hidden="true"
              version="1.1"
	...
	C445.675,395.225,423.654,420.978,397.189,441.202z"
          ...
          <button
            ...
            value={2}
            onClick={handelOnClick}
            class="inline-flex items-center px-4 sm:px-10 py-4 text-sm font-medium text-[#f3f3f3] bg-[#2e2e2e] border border-gray-400  hover:bg-gray-900 hover:text-[#1D94D4] focus:ring-2 focus:ring-[#1D94D4] focus:text-[#1D94D4]">
            <svg
              class="w-5 h-5 mr-2"
              aria-hidden="true"
              fill="currentColor"
          ...
          <button
            ...
            value={3}
            onClick={handelOnClick}
            class="inline-flex items-center px-4 sm:px-10 py-4 text-sm font-medium text-[#f3f3f3] bg-[#2e2e2e] border border-gray-400 rounded-r-lg hover:bg-gray-900 hover:text-[#1D94D4] focus:ring-2 focus:ring-[#1D94D4] focus:text-[#1D94D4]">
            <svg
              class="w-3 h-3 mr-2"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
